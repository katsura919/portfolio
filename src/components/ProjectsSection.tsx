...
const ProjectsSection = () => {
  return (
    <section className="w-full py-20 bg-gradient-to-b from-gray-900 via-gray-900 to-gray-950" id="projects">
          ...
          {projects.map((project, index) => (
            ...
            >
              <CardContainer className="inter-var">
                <CardBody className="bg-gray-800/50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-full h-auto rounded-xl p-6 border">
                  <CardItem
                    translateZ="50"
